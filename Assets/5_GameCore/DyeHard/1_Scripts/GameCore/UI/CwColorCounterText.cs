...
namespace PaintCore
{
	...
	public class CwColorCounterText : MonoBehaviour
	{
		...
		public CwColor CW_Color
		{
			set { color = value; }
			get { return color; }
		}

		[SerializeField] private CwColor color;
		...
		protected virtual void Update()
		{
			...
			long count = CwColorCounter.GetCount(color, finalCounters);
			...
			// string final = format;
			float percent = CwCommon.RatioToPercentage(CwHelper.Divide(count, total), decimalPlaces);
			//
