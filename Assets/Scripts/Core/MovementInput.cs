...
public class MovementInput : MonoBehaviour
{
    ...
    {
        // Using the settings from MovementInputSettings
        inputX = movementSettings.rightJoystick.Direction.x;
        inputZ = movementSettings.rightJoystick.Direction.y;
    ...
    void InputMagnitude()
    {
        ...
        anim.SetBool("OnShooting", movementSettings.leftJoystick.Direction.magnitude > 0.1f);
