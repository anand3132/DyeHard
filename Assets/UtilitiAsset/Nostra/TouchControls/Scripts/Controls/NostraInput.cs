...
{
    public sealed class NostraInput : MonoBehaviour
    {
        static NostraInput instance
        {
            get
            {
                if ( m_Instance == null )
                {
                    m_Instance = FindObjectOfType<NostraInput> ( );
                }
        ...
        static void InitControllers ()
        {
            ...
            m_Buttons = GetControllers<NostraButton> ( );
        }
        ...
        public static bool GetButtonDown ( string buttonName )
        {
            ...
            foreach ( NostraButton button in buttons )
